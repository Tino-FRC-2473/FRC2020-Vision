...
parser.add_argument("inputDepth", help="path of the CSV file to read from")
parser.add_argument("inputImage", help="path of the image file to read from")
parser.add_argument("destination", help="file to save the results to")
args = parser.parse_args()

if args.generator == "DepthDataGenerator":
    depth_data_generator = DepthDataGenerator(args.inputDepth, args.inputImage)
